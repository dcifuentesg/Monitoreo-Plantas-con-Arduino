...
def menu6():
    def menu10():
        ...
        label11=Label(frame1,text=str(path),font=("Little Comet Bubling Demo Version",24),bg="white")
        label11.place(x=550,y=140)
        inputs.pop(0)
        inputs.pop(0)
    ...
    label2=Label(frame1,text="Por mejorar",font=("Little Comet Bubling Demo Version",42),bg="white")
    label2.place(x=360,y=20)
    
    label3=Label(frame1,text="A continuacion mostraremos o mencionaremos aquello \nnos hubiera gustado implementar",font=("Little Comet Bubling Demo Version",16),bg="white",justify="left")
...
def menu5():
    ...
    def revisaTemperatura():
        ...
        for i in range(len(temp)):
            if(temp[i]>mini):
                mini = temp[i]
        if maxi>45:
            pila.apilar("Dejar en un lugar con sombra  \npara que disminuya  \nla temperatura")
            label4=Label(frame1,text="-La temperatura es muy alta ",font=("Little Comet Bubling Demo Version",14),bg="white",justify="left")
            label4.place(x=360,y=180)
        elif mini>5:
            pila.apilar("Dejar en un lugar con luz \npara que aumente \nla temperatura")
            label4=Label(frame1,text="-La temperatura es muy baja",font=("Little Comet Bubling Demo Version",14),bg="white",justify="left")
            label4.place(x=360,y=180)
        else:
            label4=Label(frame1,text="-La temperatura no tiene valores criticos , pero deberias\nrevisar las tareas",font=("Little Comet Bubling Demo Version",14),bg="white",justify="left")
            label4.place(x=360,y=180)
    ...
    def revisaAire():
        ...
        if maxi>70:
            pila.apilar("Dejar a la planta cubierta  \npara que reciba menos \nhumedad")
            label4=Label(frame1,text="-La humedad de aire es muy alta ",font=("Little Comet Bubling Demo Version",14),bg="white",justify="left")
            label4.place(x=360,y=230)
        elif mini < 15:
            pila.apilar("Dejar a la planta descubierta y al aire libre \npara que reciba mas \nhumedad")
            label4=Label(frame1,text="-La humedad de aire es muy  baja ",font=("Little Comet Bubling Demo Version",14),bg="white",justify="left")
            label4.place(x=360,y=230)
        else:
            label4=Label(frame1,text="-La humedad del aire no tiene valores criticos , pero \ndeberias revisar las tareas",font=("Little Comet Bubling Demo Version",14),bg="white",justify="left")
            label4.place(x=360,y=230)
    ...
    def revisaHumedad():
        ...
        if maxi<1000:
            pila.apilar("Regar lo mas pronto posible")
            label7=Label(frame1,text="-La humedad del suelo es muy baja",font=("Little Comet Bubling Demo Version",14),bg="white",justify="left")
            label7.place(x=360,y=300)
        elif mini<400:
            pila.apilar("Drenar agua \n la humedad es muy alta")
            label7=Label(frame1,text="-La humedad esta muy baja \nPoner un poco de agua al suelo ",font=("Little Comet Bubling Demo Version",14),bg="white",justify="left")
            label7.place(x=360,y=300)
        else:
            label7=Label(frame1,text="-La humedad del suelo no tiene valores criticos , pero \ndeberias revisar las tareas",font=("Little Comet Bubling Demo Version",14),bg="white",justify="left")
            label7.place(x=360,y=300)
    ...
    def revisaLuz():
        ...
        if mini<0.2:
            pila.apilar("Dejar a la luz, \nluz muy baja")
            label9=Label(frame1,text="-Muy poca luz",font=("Little Comet Bubling Demo Version",14),bg="white",justify="left")
            label9.place(x=360,y=380)
        elif maxi>0.8:
            label9=Label(frame1,text="-Demaciada luz ",font=("Little Comet Bubling Demo Version",14),bg="white",justify="left")
            label9.place(x=360,y=380)
            pila.apilar("Evitar que le llegue \nluz 1(H)")
        else:
            label9=Label(frame1,text="-La luz no tiene valores criticos , pero \ndeberias revisar las tareas",font=("Little Comet Bubling Demo Version",14),bg="white",justify="left")
            label9.place(x=360,y=380)
    
    def imprimeTareas():
        particiones=pila.size
        largo=261
        ancho=140
        if particiones>=1:
            string1=str(pila.desapilar())
...
def menu3():  
    ...
    button5b=Button(inicio,image=button_5,command=tendencias,borderwidth=0)
    button5b.image=button_5
    button5b.place(x=650,y=150)
